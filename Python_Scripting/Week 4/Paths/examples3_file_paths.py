...
def run_absolute_path_examples():
    ...
    current_abs_path = r"C:\Users\fredr\OneDrive\Desktop\P4E\Python Scripting\Week 4\Paths\Current_file.txt.txt"
    child_abs_path = r"C:\Users\fredr\OneDrive\Desktop\P4E\Python Scripting\Week 4\Paths\Child\Child_file.txt"
    parent_abs_path = r"C:\Users\fredr\OneDrive\Desktop\P4E\Python Scripting\Week 4\parent_file.txt.txt"
    print("absolute_path function")
...
def run_relative_path_examples():
    ...
    print("relative path function")
    echo_file("Current_file.txt.txt")
    echo_file("Child/Child_file.txt.txt")           # Note that slash works on Windows
    echo_file("../parent_file.txt.txt")
    print()
...
def run_os_path_examples():
    ...
    current_abs_path = os.path.abspath("Current_file.txt.txt")
